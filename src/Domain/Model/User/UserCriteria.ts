...
class UserCriteria extends CriteriaWithId
{
    ...
    public static createByUsername<T extends UserCriteria>(this: new () => T, username: string): T
    {
    ...
    public static createByEmail<T extends UserCriteria>(this: new () => T, email: string): T
    {
